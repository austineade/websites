...
*/
	...
	var idOfFolderTrees = ['areas_tree','categories_tree'];
	
	//var imageFolder = 'images/';	// Path to images
	var folderImage = 'context_menu_folder.gif';
	var plusImage = 'context_menu_plus.gif';
	var minusImage = 'context_menu_minus.gif';
	var initExpandedNodes = '';	// Cookie - initially expanded nodes;
	var useAjaxToLoadNodesDynamically = true;
	var ajaxRequestFile = 'context_menu.php';
	...
	*/
	...
	function addNewNode(e)
	{
		...
		li.className='context_menu_sheet.gif';
	...
	function initTree()
	{
		...
		for(var treeCounter=0;treeCounter<idOfFolderTrees.length;treeCounter++){
			if (!document.getElementById(idOfFolderTrees[treeCounter])) return;
