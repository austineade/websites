...
$from = 0;
$q = dq("select * from $s[pr]users group by n order by $order_by limit $from,$s[u_per_page]",1);
...
$images = detail_page_images('u',$images[$a[n]],$a[n],0,$a);
...
if (!$a[pictures_gallery]) $a[pictures_gallery] = '<img border=0 src="'.$s[site_url].'/images/no_picture.png">';
