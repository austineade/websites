...
foreach ($s as $k=>$v) if (!is_object($v)) $s[$k] = htmlspecialchars($v);
...
{ $s[site_url] = str_replace('/administration/home.php?action=left_frame','',getenv('HTTP_REFERER'));
  ...
  $s[featured_img] = $s[site_url].'/images/corner_featured.png';
...
$test = strip_tags($s[featured_img]); if ($test!=$s[featured_img]) $s[featured_img] = $s[site_url].'/images/corner_pick.png';
...
<a href="javascript:show_config(1)" style="font-weight:bold;">Main configuration</a> &nbsp;
<a href="javascript:show_config(2)" style="font-weight:bold;">Home page & Classifieds & Payments</a> &nbsp;
<a href="javascript:show_config(3)" style="font-weight:bold;">Users & Twitter & Facebook & URL's</a> &nbsp;
</td>
</tr>
<tr><td align="center">
<tr><td>
...
<td align="left" valign="top"><input class="form-control" style="width:98%" name="p_user" value="<?PHP echo $i1[p_user] ?>"><?PHP echo $i[p_user] ?></td>
</tr>
<tr>
<td align="left" valign="top">Your password at AbScripts.com users area *</td>
<td align="left" valign="top"><input class="form-control" style="width:98%" name="p_pass" type="password" value="<?PHP echo $i1[p_pass] ?>"><?PHP echo $i[p_pass] ?></td>
</tr>
<tr>
...
<td align="left" valign="top"><INPUT class="form-control" maxLength=255 style="width:98%" name="p_domain" value="<?PHP echo $s[p_domain]; ?>"><br>
...
<td align="left" valign="top"><INPUT class="form-control" style="width:98%" name="dbhost" value="<?PHP echo $s[dbhost]; ?>"></td>
</tr>
<tr>
<td align="left" valign="top">Name of your mysql database *</td>
<td align="left" valign="top"><INPUT class="form-control" style="width:98%" name="dbname" value="<?PHP echo $s[dbname]; ?>"></td>
</tr>
<tr>
<td align="left" valign="top">Your mysql database username</td>
<td align="left" valign="top"><input class="form-control" style="width:98%" name="dbusername" value="<?PHP echo $i1[dbusername] ?>"><?PHP echo $i[dbusername] ?></td>
</tr>
<tr>
<td align="left" valign="top">Mysql database password</td>
<td align="left" valign="top"><input class="form-control" style="width:98%" name="dbpassword" value="<?PHP echo $i1[dbpassword] ?>"><?PHP echo $i[dbpassword] ?></td>
</tr>
<tr>
<td align="left" valign="top">Prefix of all tables *</td>
<td align="left" valign="top"><INPUT class="form-control" maxLength="10" style="width:100px" name="pr" value="<?PHP echo $s[pr]; ?>" disabled></td>
</tr>
...
<td align="left" valign="top">Lock given account and IP address for <input class="form-control" maxlength=5 size=5 name="log_fail_hours" value="<?PHP echo $s[log_fail_hours] ?>"> hours<br>after <input class="form-control" maxlength=5 size=5 name="log_fail_max" value="<?PHP echo $s[log_fail_max] ?>"> failed attempts to log in<br></td>
</tr>
<tr>
...
<td align="left" valign="top"><INPUT class="form-control" style="width:98%" name="secretword" value="<?PHP echo $s[secretword]; ?>"></td>
</tr>
...
<td align="left" valign="top"><select class="form-control" name="def_style" value="<?PHP echo $s[def_style]; ?>">
<?PHP
...
<td align="left" valign="top"><INPUT class="form-control" style="width:98%" name="phppath" value="<?PHP echo $s[phppath]; ?>"><br><span class="text10">Example for Linux: /htdocs/sites/user/html/gold_classifieds<br>Example for Windows: C:/somefolder/domain.com/gold_classifieds</span></td>
</tr>
<tr>
<td align="left" valign="top">URL of the folder where your scripts reside *<br><span class="text10">No trailing slash</span></td>
<td align="left" valign="top"><INPUT class="form-control" style="width:98%" name="site_url" value="<?PHP echo $s[site_url] ?>"></td>
</tr>
<tr>
...
<td align="left" valign="top"><input class="form-control" style="width:50px" name="in_templates" value="<?PHP echo $s[in_templates]; ?>"></td>
</tr>
<tr>
<td align="left" valign="top">Date format</td>
<td align="left" valign="top">
<select class="form-control" name="date_form_1">
...
<select class="form-control" name="date_form_1a">
...
<select class="form-control" name="date_form_2">
...
<select class="form-control" name="date_form_2a">
...
<select class="form-control" name="date_form_3">
...
<select class="form-control" name="date_form_3a">
...
<td align="left" valign="top"><select class="form-control" name="time_form">
...
<td align="left" valign="top"><input class="form-control" maxlength=5 style="width:50px" name="timeplus" value="<?PHP echo $s[timeplus]/3600; ?>"><span class="text10"><br />Example: Time on server is 8:00 but your local time is 10:00, you will write number 2, time on server is 10:00 but your local time is 8:00, you will write number -2</span></td>
</tr>
<tr>
<td align="left" valign="top">Admin email *</td>
<td align="left" valign="top"><input class="form-control" style="width:98%" name="mail" value="<?PHP echo $s[mail]; ?>"></td>
</tr>
<tr>
<td align="left" valign="top">Title of your site *</td>
<td align="left" valign="top"><input class="form-control" style="width:98%" name="site_name" value="<?PHP echo $s[site_name]; ?>"></td>
</tr>
<tr>
...
<td align="left" valign="top"><textarea class="form-control" style="width:98%;height:150px;" name="site_keywords" rows=5><?PHP echo $s[site_keywords]; ?></textarea></td>
</tr>
<tr>
...
<td align="left" valign="top"><textarea class="form-control" style="width:98%;height:150px;" name="site_description" rows=5><?PHP echo $s[site_description]; ?></textarea></td>
</tr>
<tr>
<td align="left" valign="top">URL of your logo *</td>
<td align="left" valign="top"><input class="form-control" style="width:98%" name="logo_url" value="<?PHP echo $s[logo_url]; ?>"><br><span class="text10">It's displayed at the top of all pages.<br></span></td>
</tr>
<tr>
<td align="left" valign="top">HTML code of an ad to show at the top of all pages</td>
<td align="left" valign="top"><textarea class="form-control" style="width:98%;height:150px;" name="banner_code" rows=5><?PHP echo $s[banner_code]; ?></textarea></td>
</tr>
<tr>
<td align="left" valign="top">HTML code of an ad to show in the left column of all pages</td>
<td align="left" valign="top"><textarea class="form-control" style="width:98%;height:150px;" name="banner_code_left" rows=5><?PHP echo $s[banner_code_left]; ?></textarea></td>
</tr>
<tr>
<td align="left" valign="top">HTML code of an ad to show in the right column of all pages</td>
<td align="left" valign="top"><textarea class="form-control" style="width:98%;height:150px;" name="banner_code_right" rows=5><?PHP echo $s[banner_code_right]; ?></textarea></td>
</tr>
<tr>
<td align="left" valign="top">Character set to use for pages and emails *</td>
<td align="left" valign="top"><input class="form-control" style="width:100px" name="charset" value="<?PHP echo $s[charset]; ?>"><br /><span class="text10">Example: ISO-8859-1</span></td>
</tr>
<tr>
...
<?PHP
for ($x=1;$x<=4;$x++)
echo '<img border="0" src="../images/icon_folder_'.$x.'.gif">&nbsp;Folders with items less than <INPUT class="form-control" size=5 name="icon_folder_t'.$x.'" value="'.$s["icon_folder_t$x"].'"> days ago<br>';
...
<td align="left" valign="top"><INPUT class="form-control" size=5 name="pages_max_ads" value="<?PHP echo $s[pages_max_ads] ?>"> links to previous/next pages</span><br><span class="text10">Let it blank to display links to all pages<br></span></td>
</tr>
<tr>
...
<td align="left" valign="top" nowrap>
<select class="form-control" name="km_miles">
<?PHP
$$s[km_miles] = ' selected';
echo "
...
<td align="left" valign="top"><INPUT class="form-control" size=5 name="search_min" value="<?PHP echo $s[search_min] ?>"> or more characters can be searched</td>
</tr>
<tr>
...
<td align="left"><INPUT class="form-control" style="width:98%" name="smtp_server" value="<?PHP echo $s[smtp_server] ?>"></td>
</tr>
<tr>
<td align="left">Username </td>
<td align="left"><INPUT class="form-control" style="width:98%" name="smtp_username" value="<?PHP echo $s[smtp_username] ?>"></td>
</tr>
<tr>
<td align="left">Password </td>
<td align="left"><INPUT class="form-control" style="width:98%" name="smtp_password" value="<?PHP echo $s[smtp_password] ?>"></td>
</tr>
</table>
</td>
</tr>
...
<td align="left" valign="top">Before name <INPUT class="form-control" size=5 name="alias_pref" value="<?PHP echo $s[alias_pref] ?>"> After name <INPUT class="form-control" size=5 name="alias_after" value="<?PHP echo $s[alias_after] ?>"></td>
</tr>
<tr>
...
<td align="left" valign="top"><textarea class="form-control" style="width:98%;height:250px;" name="ignored_tags" rows=15><?PHP echo $s[ignored_tags]; ?></textarea></td>
</tr>
<tr>
<td align="left">Watermark text to use on uploaded images </td>
<td align="left"><INPUT class="form-control" style="width:98%" name="watermark_text" value="<?PHP echo $s[watermark_text] ?>"></td>
</tr>
<tr>
<td align="left" valign="top">Custom fields are shared by all categories </td>
<td align="left" valign="top"><input type="checkbox" name="share_usit" value="1"<?PHP if ($s[share_usit]) echo ' checked'; ?>><br /><span class="text10">If not checked, each first level category can have its own unique custom fields.<br /></span></td>
</tr>
<tr>
<td align="left" valign="top">Existing classifieds can be moved to other main category </td>
<td align="left" valign="top"><input type="checkbox" name="move_main_cat" value="1"<?PHP if ($s[move_main_cat]) echo ' checked'; ?>><br /><span class="text10">Not recommended if you use custom fields for individual categories.<br /></span></td>
</tr>
...
<td align="left" valign="top"><INPUT class="form-control" size=5 name="visits_today_unique" value="<?PHP echo $s[visits_today_unique] ?>"> minutes</td>
</tr>
-->
<!--
...
<td align="left" valign="top"><INPUT class="form-control" maxLength=5 size=5 name="index_max_subc" value="<?PHP echo $s[index_max_subc] ?>"></td>
</tr>
<tr>
<td align="left" valign="top">Character(s) to separate subcategories </td>
<td align="left" valign="top"><INPUT class="form-control" maxLength=10 size=5 name="ind_sep_subc" value="<?PHP echo $s[ind_sep_subc] ?>"></td>
</tr>
<!--
<tr>
...
<td align="left" valign="top"><INPUT class="form-control" style="width:98%" name="home_map_address" value="<?PHP echo $s[home_map_address]; ?>"></td>
</tr>
<tr>
<td align="left" valign="top">Co-ordinates to show in the center of map on the home page </td>
<td align="left" valign="top">Latitude: <INPUT class="form-control" style="width:150px" name="home_map_lat" value="<?PHP echo $s[home_map_lat]; ?>"> Longitude: <INPUT class="form-control" style="width:150px" name="home_map_lon" value="<?PHP echo $s[home_map_lon]; ?>"><br><span class="text10">Keep these fields empty to automatically count these values for the address entered above<br></span></td>
</tr>
<tr>
<td align="left" valign="top">Map zoom </td>
<td align="left" valign="top"><select class="form-control" name="home_map_zoom">
<?PHP
unset($selected);
...
<tr>
<td align="left" valign="top">Google map API key *</span>
<td align="left" valign="top"><input class="form-control" style="width:98%" name="google_map_api_key" value="<?PHP echo $s[google_map_api_key] ?>"><br /><span class="text10"><a href="https://console.developers.google.com/flows/enableapi?apiid=maps_backend,geocoding_backend,directions_backend,distance_matrix_backend,elevation_backend,places_backend&keyType=CLIENT_SIDE&reusekey=true" target="_blank">Click here to get it</a></span></td>
</tr>


<!--
<tr>
<td align="left" valign="top">Banners in the left column </td>
<td align="left" valign="top">
<?PHP
for ($x=1;$x<=10;$x++)
echo '<textarea class="form-control" style="width:98%;height:150px;" name="banner_left'.$x.'" rows=5>'.$s["banner_left$x"].'</textarea><br>';
?>
</td>
</tr>
<tr>
<td align="left" valign="top">Banners in the right column </td>
<td align="left" valign="top">
<?PHP
for ($x=1;$x<=10;$x++)
echo '<textarea class="form-control" style="width:98%;height:150px;" name="banner_right'.$x.'" rows=5>'.$s["banner_right$x"].'</textarea><br>';
?>
</td>
</tr>
<tr>
<td align="left" valign="top">Banners at the bottom of all pages </td>
<td align="left" valign="top">
<?PHP
for ($x=1;$x<=10;$x++)
echo '<textarea class="form-control" style="width:98%;height:150px;" name="banner_bottom'.$x.'" rows=5>'.$s["banner_bottom$x"].'</textarea><br>';
?>
</td>
</tr>
-->
...
<td align="left" valign="top"><INPUT class="form-control" maxLength=3 size=5 name="per_page" value="<?PHP echo $s[per_page]; ?>"></td>
</tr>
<tr>
<td align="left" valign="top">Number of featured classifieds on the home page *</td>
<td align="left" valign="top"><INPUT class="form-control" maxLength=3 size=5 name="per_page_index" value="<?PHP echo $s[per_page_index]; ?>"></td>
</tr>
<tr>
...
<td align="left" valign="top"><INPUT class="form-control" maxLength=3 size=5 name="new_page" value="<?PHP echo $s[new_page]; ?>"></td>
</tr>
<tr>
<td align="left" valign="top">Classified ads per page on RSS pages *</td>
<td align="left" valign="top"><INPUT class="form-control" maxLength=3 size=5 name="l_rss_per_page" value="<?PHP echo $s[l_rss_per_page]; ?>"></td>
</tr>
<tr>
<td align="left" valign="top">Number of columns of listing in categories and search results *</td>
<td align="left" valign="top"><INPUT class="form-control" size=5 name="l_columns" value="<?PHP echo $s[l_columns]; ?>"></td>
</tr>
...
<td align="left" valign="top"><INPUT class="form-control" maxLength=3 size=5 name="marknew_time" value="<?PHP echo $s[marknew_time]; ?>"></td>
</tr>
<tr>
<td align="left" valign="top">Number of classified ads to mark as Popular *</td>
<td align="left" valign="top"><INPUT class="form-control" maxLength=3 size=5 name="popular" value="<?PHP echo $s[popular]; ?>"></td>
</tr>
<tr>
<td align="left" valign="top">Each classified ad can be listed in maximum of *</td>
<td align="left" valign="top"><INPUT class="form-control" maxLength=3 size=5 name="max_cats" value="<?PHP echo $s[max_cats] ?>"> categories</td>
</tr>
<tr>
<td align="left" valign="top">Each classified ad can be listed in maximum of *</td>
<td align="left" valign="top"><INPUT class="form-control" maxLength=3 size=5 name="max_areas" value="<?PHP echo $s[max_areas] ?>"> areas</td>
</tr>
<tr>
<td align="left" valign="top">Maximum of *</td>
<td align="left" valign="top"><INPUT class="form-control" maxLength=3 size=5 name="a_max_pictures" value="<?PHP echo $s[a_max_pictures] ?>"> images can be uploaded for each classified for free</td>
</tr>
<tr>
<td align="left" valign="top">Size of previews *</td>
<td align="left" valign="top">Width <INPUT class="form-control" maxLength=3 size=5 name="preview_w" value="<?PHP echo $s[preview_w] ?>"> px&nbsp;&nbsp;&nbsp; Height <INPUT class="form-control" maxLength=3 size=5 name="preview_h" value="<?PHP echo $s[preview_h] ?>"> px
</td>
<tr>
<td align="left" valign="top">Size of full size images *</td>
<td align="left" valign="top">Width <INPUT class="form-control" maxLength=3 size=5 name="full_size_w" value="<?PHP echo $s[full_size_w] ?>"> px&nbsp;&nbsp;&nbsp; Height <INPUT class="form-control" maxLength=3 size=5 name="full_size_h" value="<?PHP echo $s[full_size_h] ?>"> px
</td>
</tr>
<tr>
<td align="left" valign="top">Maximum of *</td>
<td align="left" valign="top"><INPUT class="form-control" maxLength=3 size=5 name="max_files" value="<?PHP echo $s[max_files] ?>"> files can be uploaded for each classified for free</td>
</tr>
<!--<tr>
<td align="left" valign="top">Maximum of *</td>
<td align="left" valign="top"><INPUT class="form-control" maxLength=3 size=5 name="max_videos" value="<?PHP echo $s[max_videos] ?>"> videos can be uploaded for each classified for free</td>
</tr>-->
<tr>
...
<select class="form-control" name="sortby_direct">
<?PHP
...
<td align="left" valign="top"><INPUT class="form-control" maxLength=3 size=5 name="ads_max_simcats" value="<?PHP echo $s[ads_max_simcats] ?>"></td>
</tr>
<!--
<tr>
<td align="left" valign="top">Number of classified ads in each of the small tables in the left column *</td>
<td align="left" valign="top"><INPUT class="form-control" maxLength=3 size=5 name="ads_r_n" value="<?PHP echo $s[ads_r_n] ?>"></td>
</tr>
-->
<tr>
<td align="left" valign="top">Corner image to mark new classified ads</td>
<td align="left" valign="top"><INPUT class="form-control" style="width:98%" name="new_img" value="<?PHP echo $s[new_img]; ?>"></td>
</tr>
<tr>
<td align="left" valign="top">Corner image to updated classified ads</td>
<td align="left" valign="top"><INPUT class="form-control" style="width:98%" name="upd_img" value="<?PHP echo $s[upd_img]; ?>"></td>
</tr>
<tr>
<td align="left" valign="top">Corner image to popular classified ads</td>
<td align="left" valign="top"><INPUT class="form-control" style="width:98%" name="pop_img" value="<?PHP echo $s[pop_img]; ?>"></td>
</tr>
<tr>
<td align="left" valign="top">Corner image to featured classified ads</td>
<td align="left" valign="top"><INPUT class="form-control" style="width:98%" name="featured_img" value="<?PHP echo $s[featured_img]; ?>"></td>
</tr>
...
<td align="left" valign="top"><INPUT class="form-control" size=5 size=7 name="currency" value="<?PHP echo $s[currency] ?>"><span class="text10"> Example: $</span></td>
</tr>
<tr>
<td align="left" valign="top">Sales tax to add to all payments </td>
<td align="left" valign="top"><INPUT class="form-control" maxLength=5 size=7 name="tax" value="<?PHP echo $s[tax] ?>">%<br><span class="text10">This tax is added before it sends users to payment pages. Prices displayed in users area don't include this tax.</td>
</tr>
...
<td align="left" valign="top"><INPUT class="form-control" maxLength=255 style="width:98%" name="pp_email" value="<?PHP echo $s[pp_email] ?>"></td>
</tr>
<tr>
...
<td align="left" valign="top"><INPUT class="form-control" style="width:98%" name="co_n" value="<?PHP echo $s[co_n] ?>"></td>
</tr>
<tr>
<td align="left" valign="top">Secret word </td>
<td align="left" valign="top"><INPUT class="form-control" style="width:98%" name="co_secret_word" value="<?PHP echo $s[co_secret_word] ?>"></td>
</tr>
<tr>
<td align="left" valign="top">Mode </td>
<td align="left" valign="top">
...
<tr><td align="center" colspan=2><span class="text10"><b>Another payment company</b><br>Enter complete HTML code of a link or button leading to any other payment company, it may be online or offline payment service. You also can enter instructions for multiple payment companies. These variables can be used: #%price%# (price for the ordered classified ad), #%order%# (order number).<br></td></tr>
<tr><td align="center" colspan=2><textarea class="form-control" style="width:900px;height:300px;" name="other_payment_com" rows=10><?PHP echo $s[other_payment_com] ?></textarea></td>
</tr>
</table>
</div>
...
<tr>
<td align="left" valign="top">Users can choose to receive an email each time when an ad has been added to some of the categories they bookmarked</td>
<td align="left" valign="top"><input type="checkbox" name="bookmarks_cats_email" value="1"'; if ($s[bookmarks_cats_email]) echo ' checked'; echo '></td>
</tr>
...
<td align="left" valign="top"><input class="form-control" maxLength=100 style="width:98%" name="news_'.$x.'" value="'.$s['news_'.$x].'"></td>
</tr>';
?>
<tr>
<td align="left" valign="top">Maximum number of images which can be uploaded for each user by admin *</td>
<td align="left" valign="top"><input class="form-control" size=5 name="u_max_pictures" value="<?PHP echo $s[u_max_pictures] ?>"></td>
</tr>
<tr>
...
<td align="left" valign="top">Width: <input class="form-control" size=5 name="u_image_small_w" value="<?PHP echo $s[u_image_small_w] ?>"> px&nbsp;&nbsp;Height: <input class="form-control" size=5 name="u_image_small_h" value="<?PHP echo $s[u_image_small_h] ?>"> px</td>
</tr>
<tr>
<td align="left" valign="top">Full size images&nbsp;&nbsp;</td>
<td align="left" valign="top">Width: <input class="form-control" size=5 name="u_image_big_w" value="<?PHP echo $s[u_image_big_w] ?>"> px&nbsp;&nbsp;Height: <input class="form-control" size=5 name="u_image_big_h" value="<?PHP echo $s[u_image_big_h] ?>"> px</td>
</tr>
</table>
</td>
</tr>
...
<td align="left" valign="top"><input class="form-control" size=5 name="u_per_page" value="<?PHP echo $s[u_per_page]; ?>"></td>
</tr>
-->
...
<tr><td align="center" valign="top" colspan="2">If you want to post all new and edited classifieds to Twitter, make sure that your server has available CURL Library (it's usually available)</td></tr>
...
<td align="left" valign="top"><input class="form-control" style="width:98%;" name="twitter_consumerKey" value="<?PHP echo $s[twitter_consumerKey]; ?>"></td>
</tr>
<tr>
<td align="left" valign="top">Consumer secret</td>
<td align="left" valign="top"><input class="form-control" style="width:98%;" name="twitter_consumerSecret" value="<?PHP echo $s[twitter_consumerSecret]; ?>"></td>
</tr>
<tr>
<td align="left" valign="top">Access token</td>
<td align="left" valign="top"><input class="form-control" style="width:98%;" name="twitter_oAuthToken" value="<?PHP echo $s[twitter_oAuthToken]; ?>"></td>
</tr>
<tr>
<td align="left" valign="top">Access token secret</td>
<td align="left" valign="top"><input class="form-control" style="width:98%;" name="twitter_oAuthSecret" value="<?PHP echo $s[twitter_oAuthSecret]; ?>"></td>
</tr>



<tr><td colspan=2 class="common_table_top_cell">Facebook</td></tr>
<tr><td align="center" valign="top" colspan="2">The following values are required only if you want to allow users to login with their Facebook login data, so they don't need to register. To get these values, <a target="_blank" href="https://developers.facebook.com/apps">click here</a> to register your application (site). Click to the button "Create New App". In the registration form check the field "Website with Facebook Login" and enter there URL of your site. Save the changes, they copy the App ID and App Secret values to the fields below.</td></tr>
<tr>
<td align="left" valign="top">App ID</td>
<td align="left" valign="top"><input class="form-control" style="width:98%;" name="facebook_id" value="<?PHP echo $s[facebook_id]; ?>"></td>
</tr>
<tr>
<td align="left" valign="top">App Secret</td>
<td align="left" valign="top"><input class="form-control" style="width:98%;" name="facebook_secret" value="<?PHP echo $s[facebook_secret]; ?>"></td>
</tr>
...
<td align="left" valign="top"><INPUT class="form-control" maxLength=3 size=5 name="board" value="<?PHP echo $s[board]; ?>"></td>
</tr>
<tr>
...
<td align="left" valign="top"><input class="form-control" style="width:98%" name="sitemap_location" value="<?PHP echo $s[sitemap_location] ?>"><br /><span class="text10">Example:<br />/htdocs/sites/user/html/folder/sitemap.html</span></td>
</tr>
...
<td align="left" valign="top"><input class="form-control" style="width:98%" name="g_sitemap_location" value="<?PHP echo $s[g_sitemap_location] ?>"><br /><span class="text10">Example:<br />/htdocs/sites/user/html/folder/sitemap.xml</span></td>
</tr>
...
<td align="left" valign="top"><input class="form-control" style="width:98%" name="y_sitemap_location" value="<?PHP echo $s[y_sitemap_location] ?>"><br /><span class="text10">Example:<br />/htdocs/sites/user/html/folder/sitemap.xml</span></td>
</tr>
...
<td align="left"><INPUT class="form-control" style="width:98%" style="width:98%" name="ARfold_l_cat" value="<?PHP echo $s[ARfold_l_cat] ?>"></td>
</tr>
<tr>
<td align="left" nowrap>Virtual folder to store ad detail pages *</td>
<td align="left"><INPUT class="form-control" style="width:98%" style="width:98%" name="ARfold_l_detail" value="<?PHP echo $s[ARfold_l_detail] ?>"></td>
</tr>
<tr>
...
<td align="left" valign="top"><textarea class="form-control" style="width:98%;height:150px;" name="" rows=12 cols=70>
<?PHP 
...
{ if (is_array($v)) $v = implode(',',$v);
  if (!$v) unset($in[$k]);
  else $v = str_replace("'","\'",stripslashes($v));
  $data .= "\$s[$k] = '$v';\n";
}
