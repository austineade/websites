...
{ $rozcesti = '<form action="comments.php" method="get" name="form1">'.check_field_create('admin').'
  ...
  Show comments with begin of&nbsp;&nbsp;<select class="form-control" name="from"><option value="1">1</option>';
...
'.get_item_info($in[n])
.get_options_for_item($in[n]).$comments.'</td></tr></table><br>';
ift();
}
...
<td align="left"><textarea class="form-control" style="width:550px;height:150px;" name="text">'.$comment[text].'</textarea></td>
</tr>
<tr>
<td align="left" nowrap>Author </td>
<td align="left"><input class="form-control" style="width:550px;" name="name" value="'.$comment[name].'"></td>
</tr>
<tr>
<td align="left">Email</td>
<td align="left"><input class="form-control" style="width:550px;" name="email" value="'.$comment[email].'"></td>
</tr>
