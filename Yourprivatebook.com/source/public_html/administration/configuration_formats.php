...
{ if ($formats[file_types][$n][icon]) $current_icon = '<img border="0" src="'.$s[site_url].'/images/file_icons/'.$formats[file_types][$n][icon].'">';
  ...
  echo '<tr>
  <td align="center" valign="top"><input class="form-control" size=4 maxlength=10 name="extension['.$n.']" value="'.$extension.'" style="width:50px"></td>
  <td align="center" valign="top"><input class="form-control" size=30 maxlength=100 name="mime_type['.$n.']" value="'.$formats[mime_types][$n].'" style="width:250px"></td>
  <td align="center" valign="top"><input class="form-control" size=30 maxlength=100 name="description['.$n.']" value="'.$formats[file_types][$n][description].'" style="width:250px"></td>
  ...
  <td align="center" valign="top"><input class="form-control" size=10 maxlength=50 name="icon['.$n.']" value="'.$formats[file_types][$n][icon].'" style="width:100px"></td>
...
{ $n = $max_n + $x;
  echo '<tr>
  <td align="center" valign="top"><input class="form-control" size=4 maxlength=10 name="extension['.$n.']" style="width:50px"></td>
  <td align="center" valign="top"><input class="form-control" size=30 maxlength=100 name="mime_type['.$n.']" style="width:250px"></td>
  <td align="center" valign="top"><input class="form-control" size=30 maxlength=100 name="description['.$n.']" style="width:250px"></td>
  <td align="center" valign="top"><input type="checkbox" name="allowed['.$n.']" value="1"></td>
  <td align="center" valign="top"><input class="form-control" size=10 maxlength=50 name="icon['.$n.']" style="width:100px"></td>
