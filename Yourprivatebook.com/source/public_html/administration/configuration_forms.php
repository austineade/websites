...
<td align="center" valign="top"><input class="form-control" maxLength=3 size=2 name="a_max_pictures_users" value="<?PHP echo $s[a_max_pictures_users] ?>"></td>
<td align="center" valign="top">&nbsp;</td>
</tr>
<tr>
<td align="left" valign="top">Number of fields to upload a file </td>
<td align="center" valign="top"><input class="form-control" maxLength=3 size=2 name="a_max_files_users" value="<?PHP echo $s[a_max_files_users] ?>"></td>
<td align="center" valign="top">&nbsp;</td>
</tr>
<?PHP if (is_gd())
{ echo '<tr>
...
Title <INPUT class="form-control" maxLength=5 size=5 name="ad_min_title" value="<?PHP echo $s[ad_min_title] ?>"> - <INPUT class="form-control" maxLength=5 size=5 name="ad_max_title" value="<?PHP echo $s[ad_max_title] ?>"> 255 is maximum<br>
Description <INPUT class="form-control" maxLength=5 size=5 name="ad_min_description" value="<?PHP echo $s[ad_min_description] ?>"> - <INPUT class="form-control" maxLength=5 size=5 name="ad_max_description" value="<?PHP echo $s[ad_max_description] ?>"> 255 is maximum<br>
Detailed description <INPUT class="form-control" maxLength=5 size=5 name="ad_min_detail" value="<?PHP echo $s[ad_min_detail] ?>"> - <INPUT class="form-control" maxLength=5 size=5 name="ad_max_detail" value="<?PHP echo $s[ad_max_detail] ?>"><br>
Keywords <INPUT class="form-control" maxLength=5 size=5 name="ad_min_keywords" value="<?PHP echo $s[ad_min_keywords] ?>"> - <INPUT class="form-control" maxLength=5 size=5 name="ad_max_keywords" value="<?PHP echo $s[ad_max_keywords] ?>"><br>
</td>
</tr>
<tr>
...
<tr>
<td align="left" valign="top">Use wizard to choose categories and areas<br><span class="text10">If checked, also the field above must be checked. This option also disabled the option to move existing ads to another category and area.</span></td>
<td align="left" valign="top"><input type="checkbox" name="submit_wizard" value="1"<?PHP if ($s[submit_wizard]) echo ' checked'; ?>></td>
</tr>
<tr>
<td align="left" valign="top">Users who are not registered and add a classified should read and agree to the site Terms & Conditions</td>
<td align="left" valign="top"><input type="checkbox" name="ad_v_terms" value="1"<?PHP if ($s[ad_v_terms]) echo ' checked'; ?>></td>
</tr>
<!--
<tr>
...
<INPUT type="radio" name="post_ads_who" value="3"<?PHP if ($s[post_ads_who]==3) echo ' checked'; ?>> Only users who paid for their membership<br><span class="text10">If this option is selected, also configure prices for users<br></span>
</tr>
<tr>
...
<td align="left"><INPUT class="form-control" maxLength=10 size=10 name="ad_unconfirm_delete" value="<?PHP echo $s[ad_unconfirm_delete] ?>"> days</td>
</tr>
<tr>
...
<td align="left"><INPUT class="form-control" maxLength=10 size=10 name="max_filesize" value="<?PHP echo $s[max_filesize] ?>"> bytes</td>
</tr>
<tr>
...
<tr>
<td align="left" valign="top">Number of fields to upload an image </td>
<td align="center" valign="top"><input class="form-control" maxLength=3 size=2 name="u_max_pictures_users" value="<?PHP echo $s[u_max_pictures_users] ?>"></td>
<td align="center" valign="top">&nbsp;</td>
</tr>
<?PHP if (is_gd())
{ echo '<tr>
...
<tr>
<td align="left" valign="top">Users should read and agree to the site Terms & Conditions</td>
<td align="left" valign="top"><input type="checkbox" name="u_v_terms" value="1"<?PHP if ($s[u_v_terms]) echo ' checked'; ?>></td>
</tr>
<tr>
...
<td align="left" valign="top"><input class="form-control" maxLength=5 size=5 name="user_unconfirmed_delete_after" value="<?PHP echo $s[user_unconfirmed_delete_after]; ?>"> days</td>
</tr>
<tr>
...
<td align="left" valign="top"><input class="form-control" maxLength=5 size=5 name="rate_exclude" value="<?PHP echo $s[rate_exclude] ?>">% of the best and worst rates</td>
</tr>
...
<td align="left" valign="top"><INPUT class="form-control" maxLength=5 size=5 name="m_comment" value="<?PHP echo $s[m_comment]; ?>"> characters</span></td>
</tr>
...
<td align="left" valign="top"><INPUT class="form-control" maxLength=5 size=5 name="board_max" value="<?PHP echo $s[board_max]; ?>"> characters</span></td>
</tr>
...
{ echo '<tr><td align="center" colspan=2 class="common_table_top_cell">CAPTCHA test in other forms</td></tr>
  ...
  <tr>
  <td align="left" valign="top">Message to an user</td>
  ...
  <tr>
  <td align="left" valign="top">Abuse report</td>
