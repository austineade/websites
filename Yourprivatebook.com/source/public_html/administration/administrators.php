...
<tr><td align=center><select class="form-control" name="admin">'.select_admins().'</select></td></tr>
...
{ $q = dq("select * from $s[pr]admins where n = '$in[admin]'",1); $user = mysqli_fetch_assoc($q);
  $q = dq("select * from $s[pr]admins_rights where admin = '$in[admin]'",1); while ($x = mysqli_fetch_assoc($q)) $rights[] = $x[action];
}
$all_rights = array(
...
<td align="left" colspan=2><input class="form-control" size=15 name="username" value="'.$user[username].'" maxlength=15></td>
</tr>
<tr>
<td align="left" nowrap>Password&nbsp;&nbsp;</td>
<td align="left" colspan=2><input class="form-control" size=15 name="password" maxlength=15></td>
</tr>';
else echo '<tr>
<td align="left" nowrap>Username&nbsp;&nbsp;</td>
...
<tr>
<td align="left" nowrap>Password&nbsp;&nbsp;</td>
<td align="left" colspan=2><input class="form-control" size=15 name="password" maxlength=15> <span class="text10">Leave it blank if you don\'t want to change it</span></td>
</tr>';
echo '<tr>
<td align="left" nowrap>Email&nbsp;&nbsp;</td>
<td align="left" colspan=2><input class="form-control" size=70 name="email" maxlength="255" value="'.$user[email].'"></td>
</tr>
<tr>
<td align="left" nowrap>Name&nbsp;&nbsp;</td>
<td align="left" colspan=2><input class="form-control" size=70 name="name" maxlength="255" value="'.$user[name].'"></td>
</tr>
<tr>
...
global $s;
$q = dq("select username from $s[pr]admins where n = '$form[admin]'",1); $user = mysqli_fetch_row($q);
...
while ($a=mysqli_fetch_assoc($q)) $x .= '<option value="'.$a[n].'">'.$a[username].'</option>';
return $x;
}
