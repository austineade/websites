...
<tr><td align="center"><textarea  class="form-control" style="width:550px;height:150px;" rows="10" name="item"></textarea></td></tr>
<tr><td align="center"><select class="form-control" size=1 name="addremove">
<option value="add">Add to blacklist</option>
<option value="remove">Remove from blacklist</option></select> 
<select class="form-control" size=1 name="what">
