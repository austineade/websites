...
<select class="form-control" name="delete_days_month"><option value="1">January</option><option value="2">February</option><option value="3">March</option><option value="4">April</option><option value="5">May</option><option value="6">June</option><option value="7">July</option><option value="8">August</option><option value="9">September</option><option value="10">October</option><option value="11">November</option><option value="12">December</option></select> 
<input name="delete_days_year" size="4" maxlength="4" class="form-control" value="2007"> and before</td>
</tr>
<tr>
...
<td align="left">Recount classified ads in individual categories <select class="form-control" name="do_recount_all_items_category"><option value="0">All categories</option><?PHP echo  select_list_first_categories($_GET[do_recount_all_items_category]) ?></select><span class="text10"><br>It may take up to several minutes to recount all items.</span>
</td>
</tr>
