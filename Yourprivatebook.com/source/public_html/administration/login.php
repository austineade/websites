...
{ ih();
  ...
  <td align="left"><input class="form-control" style="width:150px" name="username" size=15 maxlength=15 value="<?PHP echo $s[pusername] ?>"></td>
  </tr>
  <tr>
  <td align="left">Password</td>
  <td align="left"><input class="form-control" style="width:150px" type="password" name="password" size=15 maxlength=15 value="<?PHP echo $s[pupassword] ?>"></td>
  </tr>
  <tr>
