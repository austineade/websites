...
<tr>
<td align="left" valign="top" nowrap>Views</td>
<td align="left" valign="top">'.$ad[clicks_total].'&nbsp;</td>
</tr>
';
...
if ($in[status]=='queue') { $test_vars = get_ad_variables($in[n],0); if ($test_vars[n]) $queue_status = 'Updated'; else $queue_status = 'New'; }
...
if ($in[status]=='queue') echo '<tr>
<td nowrap align="left" valign="top">Queue status </td>
<td nowrap align="left" valign="top">'.$queue_status.'</td>
</tr>';
echo '<tr>
<td nowrap align="left" valign="top">Title </td>
<td nowrap align="left" valign="top"><input maxlength="255" name="ad['.$n.'][title]" value="'.$in[title].'" class="form-control" style="width:550px"></td>
</tr>
<tr>
<td nowrap align="left" valign="top">Short description </td>
<td nowrap align="left" valign="top"><input maxlength="255" name="ad['.$n.'][description]" value="'.$in[description].'" class="form-control" style="width:550px"></td>
</tr>
<tr>
...
<td nowrap align="left" valign="top"><input name="ad['.$n.'][keywords]" value="'.$in[keywords].'" class="form-control" style="width:550px"></td>
</tr>
<tr>
<td nowrap align="left" valign="top">URL </td>
<td nowrap align="left" valign="top"><input maxlength="255" name="ad['.$n.'][url]" value="'.$in[url].'" class="form-control" style="width:550px"></td>
</tr>
<tr>
<td nowrap align="left" valign="top">Youtube video URL </td>
<td nowrap align="left" valign="top"><input name="ad['.$n.'][youtube_video]" value="'.$in[youtube_video].'" class="form-control" style="width:550px"></td>
</tr>
<tr>
<td nowrap align="left" valign="top">Phone 1</td>
<td nowrap align="left" valign="top"><input maxlength="255" name="ad['.$n.'][pub_phone1]" value="'.$in[pub_phone1].'" class="form-control" style="width:550px"></td>
</tr>
<tr>
<td nowrap align="left" valign="top">Phone 2</td>
<td nowrap align="left" valign="top"><input maxlength="255" name="ad['.$n.'][pub_phone2]" value="'.$in[pub_phone2].'" class="form-control" style="width:550px"></td>
</tr>
<tr>
<td nowrap align="left" valign="top">Mail address </td>
<td nowrap align="left" valign="top"><input maxlength="255" name="ad['.$n.'][address]" value="'.$in[address].'" class="form-control" style="width:550px"></td>
</tr>
<tr>
...
<tr>
<td nowrap align="left" valign="top">City </td>
<td nowrap align="left" valign="top"><input maxlength="255" name="ad['.$n.'][city]" value="'.$in[city].'" class="form-control" style="width:550px"></td>
</tr>
<tr>
<td nowrap align="left" valign="top">Postal code </td>
<td nowrap align="left" valign="top"><input maxlength="255" name="ad['.$n.'][zip]" value="'.$in[zip].'" class="form-control" style="width:550px"></td>
</tr>
<tr>
<td nowrap align="left" valign="top">Region </td>
<td nowrap align="left" valign="top"><input maxlength="255" name="ad['.$n.'][region]" value="'.$in[region].'" class="form-control" style="width:550px"></td>
</tr>
<tr>
<td nowrap align="left" valign="top">Region </td>
<td nowrap align="left" valign="top"><input maxlength="255" name="ad['.$n.'][country]" value="'.$in[country].'" class="form-control" style="width:550px"></td>
</tr>
<tr>
<td nowrap align="left" valign="top">Latitude </td>
<td nowrap align="left" valign="top"><input maxlength="255" name="ad['.$n.'][latitude]" value="'.$in[latitude].'" class="form-control" style="width:550px"></td>
</tr>
<tr>
<td nowrap align="left" valign="top">Longitude </td>
<td nowrap align="left" valign="top"><input maxlength="255" name="ad['.$n.'][longitude]" value="'.$in[longitude].'" class="form-control" style="width:550px"></td>
</tr>
<tr>
...
{ echo images_form_admin('a',$in,$s[queue]);
  ...
  { echo '<tr>
    ...
    <td nowrap align="left" valign="top"><input type="file" maxlength="255" size="57" name="file_upload['.$n.']['.$x.']" class="form-control" style="width:550px">';
    ...
    <td nowrap align="left" valign="top"><input maxlength="255" name="file_description['.$n.']['.$x.']" value="'.$files[$load_n][$x][description].'" class="form-control" style="width:550px"></td>
    </tr>';	
  }
  ...
  { echo '<tr>
    ...
    <td nowrap align="left" valign="top"><input type="file" maxlength="255" size="57" name="video_upload['.$n.']['.$x.']" class="form-control" style="width:550px">';
    ...
    <td nowrap align="left" valign="top"><input maxlength="255" name="ad['.$n.'][video_url]['.$x.']" value="'.$video[$load_n][$x][url].'" class="form-control" style="width:550px"></td>
    </tr>
    <tr>
    <td nowrap align="left" valign="top">Description</td>
    <td nowrap align="left" valign="top"><input maxlength="255" name="video_description['.$n.']['.$x.']" value="'.$video[$load_n][$x][description].'" class="form-control" style="width:550px"></td>
    </tr>';	
  }
}
...
<td align="left" nowrap><select class="form-control" name="ad['.$n.'][offer_wanted]"><option value="offer"'.$offer_wanted[offer].'>Offer</option><option value="wanted"'.$offer_wanted[wanted].'>Wanted</option></select></td>
</tr>';
if ($category[price])
echo '<tr>
<td align="left" valign="top">Price</td>
<td nowrap align="left" valign="top">'.$s[currency].'<input maxlength="10" size="10" name="ad['.$n.'][price]" value="'.$in[price].'" class="form-control"></td>
</tr>';
echo areas_rows_form($in);
echo categories_rows_form('ad',$in);
echo '<tr>
<td nowrap align="left" valign="top">Rewrite URL </td>
<td nowrap align="left" valign="top"><input maxlength="255" name="ad['.$n.'][rewrite_url]" value="'.$in[rewrite_url].'" class="form-control" style="width:550px"></td>
</tr>
<tr>
...
<td nowrap align="left" valign="top"><input maxlength="10" size="10" name="ad['.$n.'][x_pictures_max]" value="'.$in[x_pictures_max].'" class="form-control"></td>
</tr>
<tr>
...
<td nowrap align="left" valign="top"><input maxlength="10" size="10" name="ad['.$n.'][x_files_max]" value="'.$in[x_files_max].'" class="form-control"></td>
</tr>
<tr>
...
<td nowrap align="left" valign="top"><input maxlength="255" name="ad['.$n.'][x_paypal_email]" value="'.$in[x_paypal_email].'" class="form-control" style="width:550px"></td>
</tr>
<tr>
...
<td nowrap align="left" valign="top"><input maxlength="10" size="10" name="ad['.$n.'][x_paypal_price]" value="'.$in[x_paypal_price].'" class="form-control"></td>
</tr>
<tr>
...
<td align="left">'.date_select($in[created],'ad['.$n.'][created]').' <input maxlength="5" name="ad['.$n.'][created_time]" value="'.date('H:i',$in[created]).'" class="form-control" style="width:50px"> Correct time format: 15:26</td>
</tr>
<tr>
...
$owner = get_user_variables($in[owner]);

echo '
<tr>
<td nowrap align="left" valign="top">Name </td>
<td nowrap align="left" valign="top"><input maxlength="255" name="ad['.$n.'][name]" value="'.$in[name].'" class="form-control" style="width:550px"></td>
</tr>
<tr>
<td nowrap align="left" valign="top">Email </td>
<td nowrap align="left" valign="top"><input maxlength="255" name="ad['.$n.'][email]" value="'.$in[email].'" class="form-control" style="width:550px"></td>
</tr>
<tr>
<td align="left" valign="top" nowrap>Owner\'s email</td>
<td nowrap align="left" valign="top"><input maxlength="255" name="ad['.$n.'][owner_email]" value="'.$owner[email].'" class="form-control" style="width:550px"><br><span class="text10">Applicable only if the owner is a registered user<br></span></td>
</tr>';
if ($in[status]=='queue')
{ echo '<tr><td nowrap class="common_table_top_cell" colspan="2">Options</td></tr>
  ...
  <td align="left" nowrap><input type="radio" name="ad['.$n.'][approve]" value="no" id="reject_'.$n.'">and send email: <select class="form-control" name="ad['.$n.'][reject_email]">'.$in[reject_emails].'</select>
  ...
  <td><input class="form-control" name="ad['.$n.'][email_subject]" size="60"></td>
  </tr>
  <tr>
  ...
  <td><textarea class="form-control" style="width:550px;height:150px;" name="ad['.$n.'][email_text]" rows="10" cols="60"></textarea>
  </tr>
  </table></DIV>
  </td></tr>';
}
...
$owner = get_usern($in[owner_email]);
...
if (($in[url]) AND (!strstr($in[url],'http://')) AND (!strstr($in[url],'https://')) ) $in[url] = "http://$in[url]";
