...
<td align="left"><input class="form-control" name="n"maxlength=15 style="width:100"></td>
</tr>
<tr>
<td align="left" nowrap>Email contains </td>
<td align="left"><input class="form-control" name="email" style="width:550px" maxlength=100></td>
</tr>
<tr>
<td align="left" nowrap>Any field contains </td>
<td align="left"><input class="form-control" name="any" style="width:550px" maxlength=100></td>
</tr>
<tr>
<td align="left" nowrap>Name contains </td>
<td align="left"><input class="form-control" name="name" style="width:550px" maxlength=100></td>
</tr>
<?PHP
if ($s[post_ads_who]==2)
{ echo '<tr>
...
<td align="left"><select class="form-control" name="number_ads_select"><option value="more_than">>=</option><option value="less_than"><=</option></select> <input class="form-control" name="number_ads" size=5 maxlength=5></td>
</tr>
<tr>
...
<td align="left">
<select class="form-control" name="sort"><option value="email">Email</option><option value="name">Name</option><option value="joined">Date joined</option><option value="ads">Number of classifieds</option></select>
...
{ $rozcesti = '<form action="users.php" method="get" name="form1">'.check_field_create('admin').'<input type="hidden" name="action" value="users_searched">';
  ...
  $rozcesti .= 'Show users with begin of <select class="form-control" name="from"><option value="1">1</option>';
...
while ($x = mysqli_fetch_assoc($q)) show_one_user($x,$in);
ift();
}
...
<tr><td class="common_table_top_cell">'.$data[name].'</td></tr>
<tr><td align="center">
...
[<a target="_self" href="orders_payments.php?action=orders_searched&user='.$data[n].'">Payments for ads</a>]&nbsp;
[<a target="_self" href="orders_payments.php?action=orders_searched&what=u&user='.$data[n].'">Payments for membership</a>]&nbsp;
...
{ echo '<tr><td align="left" colspan="2" nowrap>
  ...
  and send email: <select class="form-control" name="user['.$n.'][reject_email]">'.$user[reject_emails].'
  </select>
  ...
  <td><input class="form-control" name="user['.$n.'][email_subject]" size="70"></td>
  </tr>
  <tr>
  <td align="left" valign="top">Text<br /><span class="text10">Available variables:<br />#%email%# - User Email<br />#%name%# - Name<br /></span></td>
  <td><textarea class="form-control" style="width:550px;height:100px;" name="user['.$n.'][email_text]" rows="10" cols="70"></textarea></td>
  </tr>
  </table></DIV>
  </td></tr>';
}
...
<td align="left"><input class="form-control" name="user['.$n.'][email]" style="width:550px" maxlength=255 value="'.$user[email].'"></td>
</tr>';
if ($user[current_action]=='user_create')
echo '<tr>
<td align="left">Password </td>
<td align="left"><input class="form-control" name="user['.$n.'][password]" style="width:150px" maxlength="15" value="'.$user[password].'"></td>
</tr>';
else echo '<tr>
<td align="left">Password </td>
<td align="left"><input class="form-control" name="user['.$n.'][password]" style="width:150px" maxlength="15" value=""><span class="text10"> Leave blank to keep current password</span></td>
</tr>';
echo '<tr>
<td align="left">Name </td>
<td align="left"><input class="form-control" name="user['.$n.'][name]" style="width:550px" maxlength=255 value="'.$user[name].'"></td>
</tr>
<tr>
<td align="left">Nick name </td>
<td align="left"><input class="form-control" name="user['.$n.'][nick]" style="width:550px" maxlength=255 value="'.$user[nick].'"></td>
</tr>
<tr>
<td align="left">Company </td>
<td align="left"><input class="form-control" name="user['.$n.'][company]" style="width:550px" maxlength=255 value="'.$user[company].'"></td>
</tr>
<tr>
<td align="left">Address 1 </td>
<td align="left"><input class="form-control" name="user['.$n.'][address1]" style="width:550px" maxlength=255 value="'.$user[address1].'"></td>
</tr>
<tr>
<td align="left">Address 2 </td>
<td align="left"><input class="form-control" name="user['.$n.'][address2]" style="width:550px" maxlength=255 value="'.$user[address2].'"></td>
</tr>
<tr>
<td align="left">Address 3 </td>
<td align="left"><input class="form-control" name="user['.$n.'][address3]" style="width:550px" maxlength=255 value="'.$user[address3].'"></td>
</tr>
<tr>
<td align="left">Country </td>
<td align="left"><input class="form-control" name="user['.$n.'][country]" style="width:550px" maxlength=255 value="'.$user[country].'"></td>
</tr>
<tr>
<td align="left">Phones </td>
<td align="left"><input class="form-control" name="user['.$n.'][phone1]" style="width:550px" maxlength=255 value="'.$user[phone1].'"></td>
</tr>
<tr>
<td align="left">&nbsp; </td>
<td align="left"><input class="form-control" name="user['.$n.'][phone2]" style="width:550px" maxlength=255 value="'.$user[phone2].'"></td>
</tr>
<tr>
<td align="left">Paid until </td>
<td align="left" nowrap>'.date_select($user[paid_until],'user['.$n.'][paid_until]').'</td>
</tr>
<tr>
<td align="left">Style </td>
<td align="left"><select class="form-control" name="user['.$n.'][style]">'; echo styles_select_box($user[style]); echo '</select></td>
</tr>
<tr>
...
if ($s[bookmarks_cats_email])
{ echo '<tr>
  <td align="left" valign="top" colspan="2">Email user when an ad has been added to a category in user favorites <input type="checkbox" name="user['.$n.'][email_category]" value="1"'; if ($user[email_category]) echo ' checked'; echo '></td>
  </tr>';
}
...
<td align="left"><input class="form-control" name="user['.$n.'][url]" style="width:550px" maxlength=255 value="'.$user[url].'"></td>
</tr>
<tr>
<td align="left">Site title</td>
<td align="left"><input class="form-control" name="user['.$n.'][site_title]" style="width:550px" maxlength=255 value="'.$user[site_title].'"></td>
</tr>
<tr>
...
while ($x = mysqli_fetch_assoc($q)) $ads_list[] = $x[n];
...
<tr><td align="left"> 
Replace the variable #%classifieds%# with classifieds created in the last <input class="form-control" type="text" size="2" name="days" value="<?PHP echo $days; ?>"> days</td></tr>
<tr><td align="left">Subject: <input class="form-control" type="text" style="width:550px" name="subject" value="<?PHP echo $data[subject]; ?>"></td></tr>
<tr><td align="left">Text:<br /><textarea class="form-control" style="width:700px;height:250px;" name="text"><?PHP echo $text; ?></textarea></td></tr>
...
<input type="radio" value="test" name="what"> Send only a test email to <input class="form-control" type="text" style="width:550px" name="test_email" value="<?PHP echo $s[mail]; ?>"></td></tr>
...
{ $emaily = dq("select * from $s[pr]users where news$data[newsletter] = '1' and approved = '1' and confirmed = '1'",1);
  $num_rows = mysqli_num_rows($emaily);
  ...
  while ($address = mysqli_fetch_assoc($emaily))
  { $line = $data[text]; $data[subject] = unreplace_once_html($data[subject]);
    $value[classifieds] = $b[classifieds];
...
<td align="left" valign="top"><input class="form-control" type="text" name="subject" value="<?PHP echo $data[subject]; ?>" style="width:550px"></td>
</tr>
<tr>
<td align="left" valign="top">Text</td>
<td align="left" valign="top"><textarea class="form-control" style="width:550px;height:300px;" rows=20 name="text"><?PHP echo $data[text]; ?></textarea></td>
</tr>
<tr>
...
<td align="left" valign="top" nowrap><input type="radio" value="send" name="what" checked> Send now<br><input type="radio" value="test" name="what"> Send only a test email to <input class="form-control" type="text" size="50" name="test_email" value="<?PHP echo $s[mail]; ?>"></td>
</tr>
...
{ $rozcesti = '
  ...
  Show users with begin of&nbsp;&nbsp;<select class="form-control" name="from"><option value="1">1</option>';
  $y = ceil($pocet/$in[perpage]);  
  for ($x=1;$x<$y;$x++)
  { $od = $x * $in[perpage] + 1;
...
while ($x = mysqli_fetch_assoc($q)) { $user[$x[n]] = $x; $numbers[] = $x[n]; }
...
{ if (!$in[user][$key][approve]) continue;
  ...
  $old_data = mysqli_fetch_assoc($q); $user = array_merge((array)$old_data,(array)$user);
  if ($user[approve]=='yes')
