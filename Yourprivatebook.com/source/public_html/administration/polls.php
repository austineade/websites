...
<tr><td colspan="2" class="common_table_top_cell">Create A New Poll</td></tr>
<tr><td align="center">
<table border="0" width="100%" cellspacing="0" cellpadding="2" class="inside_table">
<tr><td align="left" nowrap>Question</td>
<td align="left"><input class="form-control" name="question" size=60 maxlength=255></td></tr>
<tr><td align="left" nowrap>Answer 1&nbsp;&nbsp;</td>
<td align="left"><input class="form-control" name="a1" size=60 maxlength=255></td></tr>
<tr><td align="left" nowrap>Answer 2&nbsp;&nbsp;</td>
<td align="left"><input class="form-control" name="a2" size=60 maxlength=255></td></tr>
<tr><td align="left" nowrap>Answer 3&nbsp;&nbsp;</td>
<td align="left"><input class="form-control" name="a3" size=60 maxlength=255></td></tr>
<tr><td align="left" nowrap>Answer 4&nbsp;&nbsp;</td>
<td align="left"><input class="form-control" name="a4" size=60 maxlength=255></td></tr>
<tr><td align="left" nowrap>Answer 5&nbsp;&nbsp;</td>
<td align="left"><input class="form-control" name="a5" size=60 maxlength=255></td></tr>
...
<br />
<form action="polls.php" method="get" name="form1"><?PHP echo check_field_create('admin') ?>
<input type="hidden" name="action" value="poll_edit">
<table border="0" width="500" cellspacing="0" cellpadding="0" class="common_table">
<tr><td colspan="2" class="common_table_top_cell">View & Edit & Delete An Existing Poll</td></tr>
<tr><td align="center">
<table border="0" width="100%" cellspacing="0" cellpadding="2" class="inside_table">
<tr><td align="center" nowrap><font color="green">Green polls are enabled</font> <font color="red">Red polls are disabled</font></td></tr>
<tr><td align="left"><?PHP echo $polls; ?></td></tr>
<tr><td align="center" colspan=2><input type="submit" name="submit" value="Submit" class="button10"></td></tr>
</table>
</td></tr></table></form><br />
<?PHP
...
<table border="0" width="500" cellspacing="0" cellpadding="0" class="common_table">
<tr><td colspan="2" class="common_table_top_cell">Edit Selected Poll</td></tr>
<tr><td align="center">
<table border="0" width="100%" cellspacing="0" cellpadding="2" class="inside_table">
<tr><td align="center" colspan=2>This poll is '.$active.'</td></tr>
<tr><td align="left" nowrap>Question</td>
<td align="left"><input class="form-control" name="question" size=60 maxlength=255 value="'.$data[question].'"></td></tr>
<tr><td align="left" nowrap>Answer 1&nbsp;&nbsp;</td>
<td align="left"><input class="form-control" name="a1" size=60 maxlength=255 value="'.$data[a1].'"></td></tr>
<tr><td align="left" nowrap>Answer 2&nbsp;&nbsp;</td>
<td align="left"><input class="form-control" name="a2" size=60 maxlength=255 value="'.$data[a2].'"></td></tr>
<tr><td align="left" nowrap>Answer 3&nbsp;&nbsp;</td>
<td align="left"><input class="form-control" name="a3" size=60 maxlength=255 value="'.$data[a3].'"></td></tr>
<tr><td align="left" nowrap>Answer 4&nbsp;&nbsp;</td>
<td align="left"><input class="form-control" name="a4" size=60 maxlength=255 value="'.$data[a4].'"></td></tr>
<tr><td align="left" nowrap>Answer 5&nbsp;&nbsp;</td>
<td align="left"><input class="form-control" name="a5" size=60 maxlength=255 value="'.$data[a5].'"></td></tr>
<tr><td align="center" colspan=2><input type="submit" name="submit" value="Submit" class="button10"></td></tr>
...
<br />
<table border="0" width="500" cellspacing="0" cellpadding="0" class="common_table">
<tr><td colspan="2" class="common_table_top_cell">Results</td></tr>
<tr><td align="center">
<table border="0" width="100%" cellspacing="0" cellpadding="2" class="inside_table">
<tr><td align="center"><span class="text13a_bold">'.$data[question].'</span></td></tr>
<tr><td align="center">'.$results.'</td></tr>
<tr><td align="center"><a href="polls.php?action=poll_reset&n='.$n.'">Reset all results of this poll to zero</a></td></tr>
