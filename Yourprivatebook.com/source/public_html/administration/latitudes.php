...
case 'latitude_edited'				: latitude_edited($_GET);
}
switch ($_POST[action]) {
...
<tr><td align="left">
This database contains latitudes and longitudes of individual cities. It\'s used by the radius searching which is available on public pages. Users can enter their postal code or city name and it can search for ads in a radius around this place.<br>
If you want to use this feature, download the following files:<br>
