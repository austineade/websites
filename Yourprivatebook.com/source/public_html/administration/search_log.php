...
<tr><td align="center">
<table border="0" width="100%" cellspacing="0" cellpadding="2" class="inside_table">
<tr><td align="center" colspan=2>Delete records with <input class="form-control" name="lessthan" size=5 maxlength=5> or less searching</td></tr>
...
{ $rozcesti = '
  ...
  Show records with begin of&nbsp;&nbsp;<select class="form-control" name="from"><option value="1">1</option>';
