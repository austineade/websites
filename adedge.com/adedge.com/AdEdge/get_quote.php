...
<div id="mainBody">
<!-- Header File Include -->
<?php include('/var/www/vhosts/95/243968/webspace/httpdocs/adedge.com/AdEdge'); ?>
<!-- /Header File Include -->
    <div id="mainContentContainer">
    	<div id="column1ContentPage">
        	<div class="ContentPageHeader">
            	<h2>Request A Quote</h2>
                <h1>You have requested a quote for the ad &quot;<?php echo $_GET['title']; ?>"</h1>
                ...
                <form action="/AdEdge/quote_thank_you.php" method="post" name="contactus" id="contactus" onsubmit="MM_validateForm('fname','','R','lname','','R','email','','RisEmail','company','','R','captcha_code','','R');return document.MM_returnValue">
                <fieldset>
