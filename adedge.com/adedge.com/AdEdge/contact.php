    ...
    <div id="mainContentContainer">
    	<div id="column1ContentPage">
        	<div class="ContentPageHeader">
                ...
                <form action="/AdEdge/contact_thank_you.php" method="post" name="contactus" id="contactus" onsubmit="MM_validateForm('fname','','R','lname','','R','email','','RisEmail','phone','','R','captcha_code','','R');return document.MM_returnValue">
                <fieldset>
