    ...
    <div id="mainContentContainer">
    	<div id="column1ContentPage">
        	<div class="ContentPageHeader">
                ...
                <p>Please provide the information below and click "Submit" to send your message to us. We'll get back to you as soon
                as possible. Or, feel free to give us a call at <b>800-558-8237</b>.</p>
            </div>
                <form action="/AdEdge/contact_thank_you.php" method="post" name="contactus" id="contactus" onsubmit="MM_validateForm('fname','','R','lname','','R','email','','RisEmail','phone','','R');return document.MM_returnValue">
                <fieldset>
                ...
                <table width="100%" border="0" cellpadding="5">
                  ...
                  <tr>
                    <td>Email<span class="style2"> *</span></td>
                ...
                <table width="100%" border="0" cellpadding="5">
  <tr>
    <td width="31%"><p>How can we help? </p>
      <p>Use this box to ask a question, make a request or leave a comment.</p></td>
    <td width="69%"><textarea name="message" cols="60" rows="10" id="message"></textarea></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
