    ...
    <div id="mainContentContainer">
    	...
    	<div id="column1ContentPage">
        	...
        	<div class="ContentPageHeader">
                ...
                <form action="/AdEdge/quote_favorites_thank_you.php" method="post" name="contactus" id="contactus" onsubmit="MM_validateForm('fname','','R','lname','','R','email','','RisEmail','company','','R','phone','','R');return document.MM_returnValue">
