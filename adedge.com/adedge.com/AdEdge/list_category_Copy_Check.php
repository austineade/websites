            ...
            <div id="categoryListing">
              <?php do { ?>
                <div class="ListStyleBox">
                  ...
                  <div class="vidresultDescription"><p>Short description:</p><?php echo $row_RSGetNodeList['field_short_description_value']; ?></div>
                  <div class="vidresultDescription"><p>Long description:</p><?php echo $row_RSGetNodeList['field_long_description_value']; ?></div>
